...
static MI_CONST MI_Boolean MSFT_nxOMSGenerateInventoryMofResource_FeatureName_Key_qual_value = 1;

static MI_CONST MI_Qualifier MSFT_nxOMSGenerateInventoryMofResource_FeatureName_Key_qual =
{
    MI_T("Key"),
    MI_BOOLEAN,
    MI_FLAG_DISABLEOVERRIDE|MI_FLAG_TOSUBCLASS,
    &MSFT_nxOMSGenerateInventoryMofResource_FeatureName_Key_qual_value
};

static MI_Qualifier MI_CONST* MI_CONST MSFT_nxOMSGenerateInventoryMofResource_FeatureName_quals[] =
{
    &MSFT_nxOMSGenerateInventoryMofResource_FeatureName_Key_qual,
};

/* property MSFT_nxOMSGenerateInventoryMofResource.FeatureName */
static MI_CONST MI_PropertyDecl MSFT_nxOMSGenerateInventoryMofResource_FeatureName_prop =
{
    MI_FLAG_PROPERTY|MI_FLAG_KEY|MI_FLAG_READONLY, /* flags */
    0x0066650B, /* code */
    MI_T("FeatureName"), /* name */
    MSFT_nxOMSGenerateInventoryMofResource_FeatureName_quals, /* qualifiers */
    MI_COUNT(MSFT_nxOMSGenerateInventoryMofResource_FeatureName_quals), /* numQualifiers */
    MI_STRING, /* type */
    NULL, /* className */
    0, /* subscript */
    offsetof(MSFT_nxOMSGenerateInventoryMofResource, FeatureName), /* offset */
...
{
    &MSFT_nxOMSGenerateInventoryMofResource_FeatureName_prop,
