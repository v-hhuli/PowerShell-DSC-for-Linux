...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_Set_Description(
    _Inout_ MSFT_nxServiceResource* self,
    _In_z_ const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_SetPtr_Description(
    _Inout_ MSFT_nxServiceResource* self,
    _In_z_ const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_Clear_Description(
    _Inout_ MSFT_nxServiceResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_Set_Runlevels(
    _Inout_ MSFT_nxServiceResource* self,
    _In_z_ const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_SetPtr_Runlevels(
    _Inout_ MSFT_nxServiceResource* self,
    _In_z_ const MI_Char* str)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_Clear_Runlevels(
    _Inout_ MSFT_nxServiceResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
...
**==============================================================================
**
** MSFT_nxServiceResource.InventoryTargetResource()
**
**==============================================================================
*/

typedef struct _MSFT_nxServiceResource_InventoryTargetResource
{
    MI_Instance __instance;
    /*OUT*/ MI_ConstUint32Field MIReturn;
    /*IN*/ MSFT_nxServiceResource_ConstRef InputResource;
    /*OUT*/ MSFT_nxServiceResource_ConstArrayRef inventory;
}
MSFT_nxServiceResource_InventoryTargetResource;

MI_EXTERN_C MI_CONST MI_MethodDecl MSFT_nxServiceResource_InventoryTargetResource_rtti;

MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Construct(
    _Out_ MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_ MI_Context* context)
{
    return MI_Context_ConstructParameters(context, &MSFT_nxServiceResource_InventoryTargetResource_rtti,
        (MI_Instance*)&self->__instance);
}

MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Clone(
    _In_ const MSFT_nxServiceResource_InventoryTargetResource* self,
    _Outptr_ MSFT_nxServiceResource_InventoryTargetResource** newInstance)
{
    return MI_Instance_Clone(
        &self->__instance, (MI_Instance**)newInstance);
}

MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Destruct(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self)
{
    return MI_Instance_Destruct(&self->__instance);
}

MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Delete(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self)
{
    return MI_Instance_Delete(&self->__instance);
}

MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Post(
    _In_ const MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_ MI_Context* context)
{
    return MI_Context_PostInstance(context, &self->__instance);
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Set_MIReturn(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_ MI_Uint32 x)
{
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Clear_MIReturn(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self)
{
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Set_InputResource(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self,
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_SetPtr_InputResource(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_ const MSFT_nxServiceResource* x)
{
    return self->__instance.ft->SetElementAt(
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Clear_InputResource(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Set_inventory(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_reads_opt_(size) const MSFT_nxServiceResource * const * data,
    _In_ MI_Uint32 size)
{
    MI_Array arr;
    arr.data = (void*)data;
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_SetPtr_inventory(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self,
    _In_reads_opt_(size) const MSFT_nxServiceResource * const * data,
    _In_ MI_Uint32 size)
{
...
MI_INLINE MI_Result MI_CALL MSFT_nxServiceResource_InventoryTargetResource_Clear_inventory(
    _Inout_ MSFT_nxServiceResource_InventoryTargetResource* self)
{
    return self->__instance.ft->ClearElementAt(
        (MI_Instance*)&self->__instance,
...
MI_EXTERN_C void MI_CALL MSFT_nxServiceResource_Invoke_InventoryTargetResource(
    _In_opt_ MSFT_nxServiceResource_Self* self,
    _In_ MI_Context* context,
    _In_opt_z_ const MI_Char* nameSpace,
    _In_opt_z_ const MI_Char* className,
